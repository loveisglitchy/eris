...
class TextChannel extends GuildChannel {
    ...
    */
    ...
    sendError(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '16711680', description: '❌ ' + content } });
    }
    
    sendNSFW() {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: 0xff0000, description: 'You can only use this command in a NSFW marked channel, you can change this in the channel settings.' } });
    }
    
    sendEmbed(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '0x7289DA', description: content } })
    }
    
    sendSuccess(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { color: '3117824', description: '✅ ' + content } })
    }
    
    loading(content, file) {
        return this.client.createMessage.call(this.client, this.id, { embed: { description: content ? content : 'This might take a couple of seconds!' } })
    }
    /**
    * Edit a message
    * @arg {String} messageID The ID of the message
